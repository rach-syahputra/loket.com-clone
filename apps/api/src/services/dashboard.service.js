...
class StatisticService {
    getDashboardSummary(organizerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const summary = yield dashboard_repository_1.default.getDashboardSummary(organizerId);
            return {
                summary
            };
        });
    ...
    getSalesStatistic(organizerId) {
        return __awaiter(this, void 0, void 0, function* () {
            const sales = yield dashboard_repository_1.default.getSalesStatistic(organizerId);
            return {
                sales
            };
        });
