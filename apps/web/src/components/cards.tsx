...
export function Card() {
  ...
  return (
    <div className='flex flex-col gap-4 overflow-x-auto px-[20px] sm:grid sm:grid-cols-2 lg:px-[50px] xl:grid xl:grid-cols-4'>
      {events.length > 0 ? (
        events.map((event) => (
          <div className='z-10' key={event.id}>
        ...
        <div className='flex h-screen w-full flex-col gap-4 sm:grid sm:w-screen sm:grid-cols-2 sm:pr-[30px] lg:w-screen lg:pr-[100px] xl:grid-cols-4'>
