...
export default function AuthDropdownMenu({
  ...
  return (
    <div
      className={cn(
        'shadow-default absolute right-0 top-12 z-50 flex w-[320px] flex-col items-center justify-center gap-2 rounded-md bg-white p-4 opacity-100 transition-all duration-300 ease-in-out',
        className
      )}
    >
      <AuthSwitch />
