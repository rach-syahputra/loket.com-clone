  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      availableSeats: Yup.number()
        .min(50, 'Jumlah Tiket Minimal 50')
      ...
      <div className='h-full w-full bg-white py-[100px]'>
        <div className='flex flex-col items-center justify-center gap-[50px]'>
          ...
          <div className='flex w-full flex-col rounded-[20px] border px-[5px] sm:px-0 xl:w-[900px]'>
            <div
              className='relative z-50 h-[200px] w-full cursor-pointer sm:h-[421px] xl:sm:w-[900px]'
                    ...
                    <li>
                      <button
                        ...
                        onClick={() => {
                          ...
                          setDropdownCategoryError('Kategori Wajib Diisi') // Trigger validation immediately
                        }}
                      >
                        Pilih Kategori
                      </button>
          ...
          <div className='z-40'>
            <div className='flex flex-col justify-center gap-4 px-[20px] sm:flex-row sm:px-0'>
              <Link
                ...
                onClick={(e) => {
                  e.preventDefault()
                  // If the current ticket type is FREE and the free modal has data, prompt before switching.
              ...
              >
                <div className='z-40 flex h-[90px] w-[300px] items-center justify-between rounded-lg border bg-white p-[20px] xl:w-[400px]'>
              ...
              <div className='relative min-h-[300px] w-[300px] rounded-xl bg-white'>
                <div className='flex h-full w-full flex-col justify-center gap-4 p-[10px]'>
                  ...
                  <button
                    ...
                    className='mt-4 w-full rounded-lg bg-[#0049CC] py-2 text-white'
                    onClick={() => {
                      // Reset local date states and clear Formik values and error messages
                      setStartDate(null)
                      setEndDate(null)
                ...
                <div className='flex flex-col gap-4 p-[20px]'>
                  ...
                  <details className='dropdown'>
                    <summary className='btn btn-ghost m-0 flex w-full justify-start border bg-white p-2 font-light text-black shadow hover:bg-white'>
                      {selectedProvince
                        ? province.find((prov) => prov.id === selectedProvince)
                            ?.name
                        : 'Pilih Provinsi'}
                    </summary>
                        ...
                        <li key={prov.id} className='truncate'>
                          <button
                            ...
                            onClick={(e) => {
                              ...
                              setProvinceError('') // Clear any previous error
                            }}
                          >
                            {prov.name}
                          </button>
                  ...
                  <button
                    ...
                    onClick={() => {
                      ...
                      if (!valid) return
                      // Clear the province error and close the modal.
                      setProvinceError('')
              ...
              <div className='relative h-auto w-[300px] rounded-xl bg-white'>
                <div className='flex flex-col gap-4 p-[20px]'>
                  ...
                  <button
                    ...
                    onClick={() => {
                      let valid = true
                      // Validate availableSeats and price as before.
                      if (!formik.values.availableSeats) {
                        formik.setFieldTouched('availableSeats', true, true)
                        valid = false
                      }
                      ...
                      // Validate ticket dates using local state.
                      if (!startTicketDate) {
          ...
          <div className='fixed bottom-0 z-50 h-[70px] border-t bg-white px-[20px] py-[15px] md:px-[80px] lg:px-[100px] xl:w-full'>
            <div className='flex justify-center sm:items-center sm:justify-between'>
              ...
              <button
                className='z-50 h-[39px] rounded-lg bg-[#0049CC] px-4 font-bold text-white sm:w-full sm:px-0 md:w-[190px] lg:w-[190px]'
                type='submit'
              >
                Buat Event Sekarang
              </button>
